...
@section('breadcrumb')
        {{ Breadcrumbs::render('reporter_lists') }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "ajax":{
                    url:"/api/admin/users/reporter_users",
                ...
                "columns":[
                    ...
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<a href="../../../image/users/reporters/profile/'+JsonResultRow.picture+'"><img src="../../../image/users/reporters/profile/'+JsonResultRow.picture+'" style="width: 80px;height: 80px"></a>';
                        },
                    },
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            if(JsonResultRow.upload_national_code){
                                var natoionl = '<a href="../../../image/users/reporters/upload/'+JsonResultRow.upload_national_code+'"><img src="../../../image/users/reporters/upload/'+JsonResultRow.upload_national_code+'" style="width: 80px;height: 80px"></a>';
                            }else{
                                var natoionl = "<div class='badge badge-warning'>کارت ملی اپلود نشده است</div>"
                            }
                            return natoionl;
                        },
                    },
...

                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='delete_category("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-trash'></i></span></button><button onclick='login_reporter("+full.user_id+")' style='background: transparent;border: none'><span class='action-edit'><i class='fa fa-sign-in'></i></span></button>";
                        }
                    }
                ],
        ...
        function login_reporter(user_id){
           $.ajax({
               url:"/admin/login_id/"+user_id,
               type:"GET",
               success:function (){
