...
@endsection
@section('title')
    لیست اسلایدر دوره ها
@endsection
@section('button')
    <a class="btn btn-primary" href="{{route('courseBanner.create')}}">افزودن  اسلایدر </a>
@endsection
@section('script')
                                ...
                                <tbody>
                                    @foreach($data['adBanners'] as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('courseBanner.edit', ['id' => $item->id])}}" style='background: transparent;border: none'>
                                                    <span class='action-edit'>
                                                        <i class='feather icon-edit'></i>
                                                    </span>
                                                </a>
                                                <form class="d-inline deleteForm" action="{{route('courseBanner.delete', ['id' => $item->id])}}" method="post">
                                                    @csrf
                                                    @method('delete')
