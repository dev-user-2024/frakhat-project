...
@section('breadcrumb')
        {{ Breadcrumbs::render('video_edit',$video->id) }}
            ...
            <div class="col-md-12 col-12">
                <div class="card" style="height: auto;">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش ویدیو </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" id="VideoSave" action="/api/admin/video_news/{{ $video->id }}" method="post">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" value="{{ $video->title_video }}" id="first-name-floating" class="form-control" placeholder="عنوان ویدیو" name="title_video">
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" value="{{ $video->link_video }}" id="first-name-floating" class="form-control" placeholder="لینک ویدیو" name="link_video">
                                        ...
                                        <div class="col-12">
                                            <div class="form-label-group">
                                                <textarea name="description" class="form-control" id="" cols="30" rows="10">{{ $video->description_video }}</textarea>
