...
@section('breadcrumb')
        {{ Breadcrumbs::render('discount_code_edit',$discount->id) }}
            ...
            <div class="col-md-12 col-12">
                <div class="card" style="height: auto;">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش کدتخفیف </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" id="categorySave" action="/api/admin/discount_code/{{ $discount->id }}" method="post" >
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-floating" value="{{ $discount->price_gift }}" class="form-control" placeholder="مبلغ کدتخفیف" name="price">
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-floating" value="{{ $discount->code }}" class="form-control" placeholder=" کدتخفیف" name="code">
