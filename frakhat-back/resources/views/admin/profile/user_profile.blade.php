                        ...
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <div class="media mb-2">
                                <a class="mr-2 my-25" href="#">
                                    <img src="@if(!empty($user->picture)) {{ url('../../image/users/profile/'.$user->picture) }}  @else {{ url('../../panelStyle/app-assets/images/portrait/small/avatar-s-18.png') }}  @endif" alt="users avatar" class="users-avatar-shadow rounded" width="90" height="90">
                                </a>
                            ...
                            <form action="/api/user/update_user" id="UpdateAdminProfile" method="post">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" placeholder="نام خانوادگی" value="{{ $user->Lname }}" name="lname">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>نام</label>
                                                <input type="text" class="form-control" placeholder="نام" value="{{ $user->Fname }}" name="fname">
                                                <div class="help-block"></div>
                                            </div>
