                ...
                "columns":[
...

                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='edit_discountcode("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-edit'></i></span></button><button onclick='delete_category("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-trash'></i></span></button><button onclick='pay_discound("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-gift'></i></span></button>";
                        }
                    }
                ],
