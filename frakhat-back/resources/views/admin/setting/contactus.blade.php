                ...
                "columns":[
                    ...
                    {data:'description'},
                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='delete_contactus("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-trash'></i></span></button>";
                        }
                    }
                ],
        ...
        function delete_contactus(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url:"/api/admin/contactus_delete/"+id,
                        type:"post",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
