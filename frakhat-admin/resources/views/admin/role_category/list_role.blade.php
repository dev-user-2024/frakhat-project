...
@endsection
@section('title')
    لیست سطح دسترسی دسته بندی خبرنگار
@endsection
@section('button')
    <a class="btn btn-primary" href="/admin/role_category_users_create">افزودن سطح دسترسی دسته بندی خبر</a>
@endsection
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "ajax":{
                    url:"/api/admin/currency_category_list",
        ...
        function delete_category(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url:"/api/admin/currency_category_delete/"+id,
                        type:"post",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
                        ...
                        success:function (){
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    location.href = "/admin/role_category_users_list"
                                }
                            })
                        }
                    })
