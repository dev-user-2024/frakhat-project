                                ...
                                <div class="card rounded-0 mb-0 p-2">
                                    <div class="card-header pt-50 pb-1">
                                        <div class="card-title">
                                            <h4 class="mb-0">ایجاد حساب کاربری خبرنگار</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body pt-0">
                                            <form >
                                                ...
                                                <div class="form-label-group">
                                                    ...
                                                    <p id="EmailReporter" class="text-danger text-right"></p>
                                                </div>
                                                <div class="form-label-group">
                                                    <input type="password" id="password" class="form-control" placeholder="رمزعبور" >
                                                    <label for="inputPassword">رمزعبور</label>
                                                    <p id="PasswordReporter" class="text-danger text-right"></p>
                                                </div>
                                                <div class="form-label-group">
                                                    <input type="text" id="national_code" class="form-control" placeholder="کدملی" >
                                                    <label for="inputPassword">کدملی</label>
                                                    <p id="nationalcodeReporter" class="text-danger text-right"></p>
                                                </div>
                                                <div class="form-label-group">
                                                    <input type="text" id="phoneNumber" class="form-control" placeholder="شماره همراه" >
                                                    <label for="inputPassword">شماره همراه</label>
