    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "ajax":{
                    url:"/api/admin/users/teacher_list",
                ...
                "columns":[
                    ...
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<a href="../../../image/users/teacher/'+JsonResultRow.avatar+'"><img src="../../../image/users/teacher/'+JsonResultRow.avatar+'" style="width: 80px;height: 80px"></a>';
                        },
                    },
                    {data:'email'},

                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='delete_category("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-trash'></i></span></button><button onclick='teacher_info("+full.id+")' style='background: transparent;border: none'><span class='action-edit'><i class='feather icon-trash'></i></span></button>";
                        }
                    }
                ],
        ...
        function teacher_info(id){
            location.href='/admin/teacher_info/'+id;
        }
