            ...
            <div class="col-md-12 col-12">
                <div class="card" style="height: auto;">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" id="VideoSave" action="/api/admin/advertising" method="post">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-floating" class="form-control" placeholder="لینک تصویر" name="link_url">
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-floating" class="form-control" placeholder="ادرس تصویر" name="image_url">
                                        ...
                                        <div class="col-12">
                                            <div class="form-label-group">
                                                <select name="posetion_adv" class="form-control" id="">
                                                    ...
                                                    <option value="section1">سکشن اول</option>
                                                    <option value="section2">سکشن دوم</option>
                                                </select>
